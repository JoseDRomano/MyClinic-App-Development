...
import {teal,beige} from "../theme/colors";
...
const Page = () => {
    ...
    return (<>
            <Head>
                <title>PATIENT PAGE YADAYADAYADA</title>
            </Head>
            <Box
                component="main"
                sx={{
                ...
                <Container maxWidth="xl">
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6} lg={1}>
                            <Divider
                                ...
                                sx={{
                                    ...
                                    borderRight: '4px solid ' + teal.main, // Customize thickness and style here
                        ...
                        <Grid item xs={12} sm={6} lg={2.3}>
                            <OverviewWidget
                                icon="2"
                                text={"Consultas que nao me apetece ir"}
                                differenceDay={"dia"}
                                difference={6}
                                positive={true}
